    ...
    renderer_2::run(
        ...
        move |draw| {
            ...
            statistics::report_value(
                ...
                (frame_start - previous_end_time).as_secs_f64().to_string(),
            );
            local_circles
                .iter()
            ...
            statistics::report_value(
                "drawing_circles",
                (circles_end - frame_start).as_secs_f64().to_string(),
            );
            local_rectangles
                .iter()
            ...
            statistics::report_value(
                "drawing_rectangles",
                (current_end_time - circles_end).as_secs_f64().to_string(),
            );
            statistics::report_value(
                "run_lambda",
                (current_end_time - frame_start).as_secs_f64().to_string(),
            );
            statistics::report_value(
                "whole_frame_time",
            ...
            statistics::report_value(
                "whole_fps",
                (1.0 / (current_end_time - previous_end_time).as_secs_f64()).to_string(),
            );
